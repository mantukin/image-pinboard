...
export const DOM = {
    ...
    get canvasSelectionBox() { return document.getElementById('canvas-selection-box'); },
    ...
    get cleanupToggleBtn() { return document.getElementById('cleanup-toggle-btn'); },
    get cleanupPanel() { return document.getElementById('cleanup-panel'); },
    get cleanupAgeSlider() { return document.getElementById('cleanup-age-slider'); },
    get cleanupDaysLabel() { return document.getElementById('cleanup-days-label'); },
    get cleanupSelectedCount() { return document.getElementById('cleanup-selected-count'); },
    get cleanupApplyBtn() { return document.getElementById('cleanup-apply-btn'); },
    get cleanupDeleteBtn() { return document.getElementById('cleanup-delete-btn'); },
    ...
    get confirmDialogMessage() { return document.getElementById('confirm-dialog-message'); },
...
export const state = {
    ...
    isGridHydrated: false,
    currentMode: 'grid',
    isWindowPinned: false,

    imageToDelete: { hash: null, hashes: [], wrapper: null, source: 'single' },
    activeCanvasHash: null,
    activeCanvasElement: null,
    selectedCanvasKeys: new Set(),
    savedCanvasScale: 1,
    cleanupDays: 30,
